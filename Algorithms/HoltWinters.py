...
class HoltWinters:
    ...
    def double_exponential_smoothing(self, alpha, beta, number_predictions):
        ...
        for n in range(1, len(self.train) + number_predictions):
            ...
            # get first trend en start level/ first value
            if n == 1:
    ...
    # Get the trend in the data. Need this together with the seasonal components
    # so we can predict te correct values
    ...
    # Given a series, alpha, beta , gamma and the number of predictions.
